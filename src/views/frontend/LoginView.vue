        ...
        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
          ...
          <div class="w-full">
            ...
            <form @submit.prevent="onSubmit">
              ...
              <input v-model="email" type="text" id="email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight">
              <span v-if="v$.email.$error" class="mt-2 text-sm text-red-500">
                {{ v$.email.$errors[0].$message }}
              </span>

              <label class="block text-gray-700 text-sm mt-3 mb-2" for="password">รหัสผ่าน</label>
              <input v-model="password" type="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight">
              <span v-if="v$.password.$error" class="mt-2 text-sm text-red-500">
